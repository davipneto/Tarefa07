...
public class AGMochila {
     ...
     */
    private static final int MAX_EXECUCOES = 1;
    /**
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (best != null) {
                ...
                if (best.valor > maiorValor) {
                    maiorValor = best.valor;
                    vezes = 1;
                } else if (best.valor == maiorValor) {
                    vezes++;
                }
            }
            ct++;
        ...
        System.out.println("Maior Valor: " + maiorValor + "  " + vezes + " vezes");
    }
}
